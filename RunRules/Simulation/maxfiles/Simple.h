 ...
 * \param [in] inscalar_SimpleKernel_h Input scalar parameter "SimpleKernel.h".
 * \param [in] inscalar_SimpleKernel_x Input scalar parameter "SimpleKernel.x".
 * \param [in] instream_dydx The stream should be of size (param_N * 4) bytes.
 * \param [in] instream_y The stream should be of size (param_N * 4) bytes.
 * \param [out] outstream_yout The stream should be of size (param_N * 4) bytes.
 */
void Simple(
	int32_t param_N,
	double inscalar_SimpleKernel_h,
	double inscalar_SimpleKernel_x,
	const float *instream_dydx,
	const float *instream_y,
	float *outstream_yout);
...
typedef struct { 
	...
	double inscalar_SimpleKernel_h; /**<  [in] Input scalar parameter "SimpleKernel.h". */
	double inscalar_SimpleKernel_x; /**<  [in] Input scalar parameter "SimpleKernel.x". */
	const float *instream_dydx; /**<  [in] The stream should be of size (param_N * 4) bytes. */
	const float *instream_y; /**<  [in] The stream should be of size (param_N * 4) bytes. */
	float *outstream_yout; /**<  [out] The stream should be of size (param_N * 4) bytes. */
} Simple_actions_t;
